(function ($) {
  ...
  //Feature Three Carousel
  if ($(".feature-three__carousel").length) {
    $(".feature-three__carousel").owlCarousel({
      loop: true,
      margin: 0,
      nav: false,
      dots: false,
  ...
  //Causes One Carousel
  if ($(".donate-page__carousel").length) {
    $(".donate-page__carousel").owlCarousel({
      loop: true,
      margin: 30,
      nav: false,
      dots: false,
  ...
  //Donations Carousel Page
  if ($(".donations-carousel-style").length) {
    $(".donations-carousel-style").owlCarousel({
      loop: true,
      margin: 30,
      nav: false,
      dots: true,
  ...
  //Donations Carousel Page
  if ($(".event-carousel-style").length) {
    $(".event-carousel-style").owlCarousel({
      loop: true,
      margin: 30,
      nav: false,
      dots: true,
  ...
  //Donations Carousel Page
  if ($(".gallery-carousel-style").length) {
    $(".gallery-carousel-style").owlCarousel({
      loop: true,
      margin: 30,
      nav: false,
      dots: true,
  ...
  // donate form
  $('.donate-page__form-buttons-item').on("click", function () {
    $('.donate-page__form-buttons-item').removeClass('active');
    $(this).addClass('active');
    var amount = $(this).find('.donate-page__form-buttons-amount').text();
    $('.donate-page__form-amount-input').val(amount);
  });
